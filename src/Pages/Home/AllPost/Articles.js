...
const Articles = () => {
    return (
        <div className='border rounded'>
            <div>
                <img src="https://i.ibb.co/PZpvxBq/Rectangle-5.png" className='img-fluid w-100' alt="" />
            </div>
            <div className='px-3'>
                <p className='fw-medium mt-3 text-base'>✍️ Article</p>
                <div className='d-flex justify-content-between align-items-center'>
                    <div>
                        <h4 className='text-lg'>What if famous brands had regular fonts? Meet RegulaBrands!</h4>
            ...
            <div className='px-3 d-flex align-items-center justify-content-between py-3'>
                <div className='d-flex align-items-center gap-2'>
                    <img width={50} height={50} className="rounded-pill object-fit-cover"
                        src="https://i.ibb.co/vBGb1xf/Rectangle-3.png" alt="" />
                    <div>
                        <span className='text-md fw-medium'>Sarthak Kamra</span>
